...
export  default function FunctionBtn (props: propsBtn) {
    ...
    return(
        <button onClick={ () => handleFunction()} className={` text-btn-res-color text-5xl rounded-full bg-btn-func-color w-24 h-24 flex items-center justify-center hover:bg-btn-def-hover-color hover:text-white transition ${props.className}`}>
